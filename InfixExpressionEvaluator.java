...
public class InfixExpressionEvaluator {
    ...
    void processOperand(double operand) {
    	...
    	//System.out.println("This number was added to the stack: " + operand);
    }
    ...
    void processOperator(char operator) {
    	...
    	if(operators.isEmpty())
    	{
        	...
        	//System.out.println("This character was added to the stack: " + operator);
    	}
    	else 
    	{
    		while(lowerPrecedence(operator))
    		{
    			if(operators.isEmpty())
    			{
    				throw new ExpressionError("Invalid Entry");
    			}
    			try
    			{
    				temp = doMath(operators.pop(), operands. pop(), operands.pop());
    				operands.push(temp);
    			}
    			catch(Exception e)
    			{
    	    	...
    	    	//System.out.println("This number was added to the stack: " + temp);
    		}
    		operators.push(operator);
	    	//System.out.println("This character was added to the stack: " + operator);
    	}
    ...
    void processOpenBracket(char openBracket) {
    	...
    	//System.out.println("This character was added to the stack: " + openBracket);
    }
    ...
    void processCloseBracket(char closeBracket) {
    	...
    	while(true)
    	{
			...
			{
				//System.out.println("I've stopped doing the bracket loop");
				break;
			}
    			temp+=recur();
    			operands.push(temp);
    			//System.out.println("This character was added to the stack: " + temp);
    ...
    boolean lowerPrecedence(char one)
    {
    	char two = ' ';
    	try
    	{
    	...
    	//System.out.println("I have checked the precendence of " + one + " and " + two + " and the boolean is " + l);
    	//System.out.println("The temps are A: " + tempA + " B: " + tempB);
    	return l;
    }
    double doMath(char oper, double num1, double num2)
    {
    	double ans=0;
    	if(oper=='+')
    	{
    	...
    	if(oper=='/')
    	{
    		if(num1==0)
    		{
    			throw new ExpressionError("Division by 0 error");
    		}
    		else
    			ans = num2/num1;
    	}
    ...
    double recur()
	{
    	...
    	else
    	{
    		...
    		else if(symbol=='^')
    		{
    			...
    			operands.push(Math.pow(operands.pop(), num));
    			return recur();
    		}
    		else if(symbol=='/')
    		{
    			if(num==0)
    			{
    				throw new ExpressionError("Divison by zero error");
    			}
